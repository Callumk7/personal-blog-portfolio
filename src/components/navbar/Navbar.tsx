...
export default function Navbar() {
    return (
        <nav className="sticky top-0 z-20 flex h-20 flex-row items-center justify-end gap-x-4 bg-neutral-200 bg-opacity-30 backdrop-blur-lg">
            ...
            <Link href="/pictures" className="px-3">
                Pictures
            </Link>
            <div className="px-3">
