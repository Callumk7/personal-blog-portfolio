...
export default async function BlogPage() {
	...
	return (
		<main className="mx-auto mb-24 w-4/5 px-8 md:w-2/3 lg:w-3/4 xl:w-2/3">
			<h1 className="pb-10 font-grotesk text-6xl text-zinc-900">Blog.</h1>
			<section className="pb-8">
				<CoverPostCard post={coverPost} />
			</section>
			<section className=" grid grid-cols-1 justify-items-stretch gap-x-5 gap-y-10 lg:grid-cols-2">
				{posts.map((post) => (
